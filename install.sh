...
install_packages(){
    ...
    if [ -n "$INSTALL" ];then
        ...
        echo "INTEL-QUEEN could not install dependencies,exiting process."
        exit
    fi
}
clear
...
clear
figlet Intel-Queen
echo "Cloning Intel-Queen git repo..."
read -p "Enter Your github username: " Intel-Queen
git clone https://github.com/"${INTEL-QUEEN}"/Intel-Queen
cd Intel-Queen
clear
...
figlet SpeedY
echo "TheSpeedY"
echo "To stop bot: ctrl+c then npm stop Intel-Queen"
npm start
